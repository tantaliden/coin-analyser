#!/usr/bin/env python3
"""
RL-Agent Progressives Training — Vom Groben zum Feinen (512-512).
...
MODEL_PATH = MODEL_DIR / "rl_ppo_trading_v6_512.zip"
...
def run():
    ...
    print("=" * 70)
    print("  RL-Agent Progressives Training — Vom Groben zum Feinen (512-512)")
    ...
    print(f"  Neues PPO-Modell erstellt: 512-512 MLP\n")
    ...
    for i, phase in enumerate(PHASES):
        ...
        # Zwischenspeichern
        phase_path = MODEL_DIR / f"rl_ppo_trading_v6_512_phase{i+1}.zip"
