...
const SETTING_DESC = {"multi_head.min_direction_confidence": "Min. Direction-Confidence (target nach Cold-Start)", "min_direction_confidence": "Min. Direction-Confidence (target nach Cold-Start)", "multi_head.max_open_predictions": "Max. gleichzeitige Predictions", "max_open_predictions": "Max. gleichzeitige Predictions", "multi_head.min_tp_pct": "Min. TP-% (Schwelle, kleiner: skip)", "min_tp_pct": "Min. TP-% (Schwelle, kleiner: skip)", "multi_head.max_sl_pct": "Max. SL-% (Risiko-Cap, größer: skip)", "max_sl_pct": "Max. SL-% (Risiko-Cap, größer: skip)", "multi_head.tp_safety_factor": "TP Safety-Factor (× Predicted-Peak)", "tp_safety_factor": "TP Safety-Factor (× Predicted-Peak)", "multi_head.sl_safety_factor": "SL Safety-Factor (× Predicted-Trough)", "sl_safety_factor": "SL Safety-Factor (× Predicted-Trough)", "multi_head.cold_start_min_n": "Cold-Start: min N für Random→Modell-Switch", "cold_start_min_n": "Cold-Start: min N für Random→Modell-Switch", "multi_head.cold_start_threshold": "Cold-Start: threshold während Lern-Phase", "cold_start_threshold": "Cold-Start: threshold während Lern-Phase", "multi_head.cold_start_max_per_scan": "Cold-Start: Max Predictions / Scan", "cold_start_max_per_scan": "Cold-Start: Max Predictions / Scan", "multi_head.cold_start_tp_raw_pct": "Cold-Start: TP-Magnitude in % (raw, vor safety)", "cold_start_tp_raw_pct": "Cold-Start: TP-Magnitude in % (raw, vor safety)", "multi_head.cold_start_sl_raw_pct": "Cold-Start: SL-Magnitude in % (raw, vor safety)", "cold_start_sl_raw_pct": "Cold-Start: SL-Magnitude in % (raw, vor safety)", "timeout_hours": "Timeout (Min)", "cooldown_seconds_per_symbol": "Cooldown pro Symbol (s)", "universe_top_n": "Universe Top-N (Coins nach Volume)", "scan_interval_seconds": "Scan-Pass-Intervall (s) — wie oft neue Predictions geprüft", "watch_interval_seconds": "Watch-Pass-Intervall (s) — wie oft TP/SL geprüft wird", "multi_head.loss_weight": "Loss-Weight (falsche Richtung: härter)", "loss_weight": "Loss-Weight (falsche Richtung: härter)", "multi_head.win_weight": "Win-Weight (richtige Richtung)", "win_weight": "Win-Weight (richtige Richtung)", "multi_head.timeout_wrong_weight": "Timeout-Wrong-Weight (Drift in Gegenrichtung)", "timeout_wrong_weight": "Timeout-Wrong-Weight (Drift in Gegenrichtung)", "multi_head.timeout_correct_weight": "Timeout-Correct-Weight (Drift in Predict-Richtung)", "timeout_correct_weight": "Timeout-Correct-Weight (Drift in Predict-Richtung)", "multi_head.timeout_flat_threshold_pct": "Timeout-Flat-Threshold % (drunter: skip-label)", "timeout_flat_threshold_pct": "Timeout-Flat-Threshold % (drunter: skip-label)", "multi_head.direction_model_type": "Direction-Modell", "direction_model_type": "Direction-Modell", "multi_head.tp_peak_share": "TP = x × erwarteter Peak (tp_peak_share, v7)", "tp_peak_share": "TP = x × erwarteter Peak (tp_peak_share, v7)", "multi_head.tp_reach_target": "TP-Reach: Ziel-Trefferquote", "tp_reach_target": "TP-Reach: Ziel-Trefferquote", "multi_head.tp_reach_step": "TP-Reach: Faktor-Step / -Min / -Max", "tp_reach_step": "TP-Reach: Faktor-Step / -Min / -Max", "multi_head.tp_reach_ewma_alpha": "TP-Reach: EWMA-Alpha", "tp_reach_ewma_alpha": "TP-Reach: EWMA-Alpha", "multi_head.sl_recover_target": "SL-Recover: Ziel-Recover-Rate (v6.7)", "sl_recover_target": "SL-Recover: Ziel-Recover-Rate (v6.7)", "multi_head.sl_reach_step": "SL-Reach: Faktor-Step / -Min / -Max", "sl_reach_step": "SL-Reach: Faktor-Step / -Min / -Max", "multi_head.sl_reach_ewma_alpha": "SL-Reach: EWMA-Alpha", "sl_reach_ewma_alpha": "SL-Reach: EWMA-Alpha", "multi_head.sl_pct_floor": "SL-% Floor (Hart-Untergrenze) / Cap (Obergrenze, leer = kein Cap)", "sl_pct_floor": "SL-% Floor (Hart-Untergrenze) / Cap (Obergrenze, leer = kein Cap)", "multi_head.profit_weight_scale": "Profit-Gewicht: Skalierung (v7)", "profit_weight_scale": "Profit-Gewicht: Skalierung (v7)", "multi_head.profit_weight_max_repeats": "Profit-Gewicht: Max-Repeats (Lern-Cap)", "profit_weight_max_repeats": "Profit-Gewicht: Max-Repeats (Lern-Cap)", "multi_head.flat_skip_threshold_pct": "Flat-Skip-Threshold % netto (v7, drunter: skip)", "flat_skip_threshold_pct": "Flat-Skip-Threshold % netto (v7, drunter: skip)", "multi_head.early_extra_pct": "Entry-Timing: Extra-% / Skip-Weight", "early_extra_pct": "Entry-Timing: Extra-% / Skip-Weight", "multi_head.n_models_direction": "Modell: n_models / grace_period / min_n_predict / scan_workers", "n_models_direction": "Modell: n_models / grace_period / min_n_predict / scan_workers", "features.whale_lookback_minutes": "Whale-Lookback (Min)", "whale_lookback_minutes": "Whale-Lookback (Min)", "features.orderflow_lookback_short_s": "Orderflow: Lookback short / long (s)", "orderflow_lookback_short_s": "Orderflow: Lookback short / long (s)", "features.orderflow_min_snapshots_short": "Orderflow: Min-Snapshots short / long", "orderflow_min_snapshots_short": "Orderflow: Min-Snapshots short / long", "features.orderflow_spoof_max_lifetime_s": "Orderflow: Spoof-Lifetime (s) / Wall-Faktor / Velocity-Fenster (s)", "orderflow_spoof_max_lifetime_s": "Orderflow: Spoof-Lifetime (s) / Wall-Faktor / Velocity-Fenster (s)", "features.sector_lookback_buckets": "Sector: Lookback-Buckets / Min-Buckets", "sector_lookback_buckets": "Sector: Lookback-Buckets / Min-Buckets", "observer.enabled": "Aktiv", "enabled": "Aktiv", "observer.check_interval_seconds": "Check-Intervall (s) / Min-Alter (Min) / Cooldown (Min)", "check_interval_seconds": "Check-Intervall (s) / Min-Alter (Min) / Cooldown (Min)", "observer.btc_move_threshold_pct": "BTC-Move-Threshold % / Window (Min) / Exit-Confidence", "btc_move_threshold_pct": "BTC-Move-Threshold % / Window (Min) / Exit-Confidence", "observer.coin_drop.enabled": "Coin-Drop: Aktiv", "observer.coin_drop.price_move_pct": "Coin-Drop: Price-Move % / Window (Min) / Baseline-Window (Min)", "price_move_pct": "Coin-Drop: Price-Move % / Window (Min) / Baseline-Window (Min)", "observer.coin_drop.min_signals": "Coin-Drop: Min-Signals / Taker-Sell-Ratio / Volume-Spike-Mult", "min_signals": "Coin-Drop: Min-Signals / Taker-Sell-Ratio / Volume-Spike-Mult", "observer.coin_drop.book_imbalance_thr": "Coin-Drop: Book-Imb / Sweep/min / Spread-Spike-Mult", "book_imbalance_thr": "Coin-Drop: Book-Imb / Sweep/min / Spread-Spike-Mult", "paper_wallet.start_balance": "Start-Balance ($)", "start_balance": "Start-Balance ($)", "paper_wallet.slippage_pct_per_trade": "Slippage % pro Trade", "slippage_pct_per_trade": "Slippage % pro Trade", "reachability.enabled": "Aktiv (nur dann wird der Filter angewendet)", "reachability.reach_rate_target": "Reach-Rate-Ziel / Peak-Share (TP = x × erwarteter Peak)", "reach_rate_target": "Reach-Rate-Ziel / Peak-Share (TP = x × erwarteter Peak)", "reachability.min_tp_pct": "Min-TP % (drunter: skip)", "reachability.lookback_days": "Historie-Lookback (Tage) / Min. Vergleichsfälle", "lookback_days": "Historie-Lookback (Tage) / Min. Vergleichsfälle", "reachability.distance_threshold": "Distanz-Schwelle (Vorboten-Ähnlichkeit, kleiner = strenger)", "distance_threshold": "Distanz-Schwelle (Vorboten-Ähnlichkeit, kleiner = strenger)", "reachability.profile_window_minutes": "Vorboten-Fenster / Sample-Step / Forward-Fenster (Min)", "profile_window_minutes": "Vorboten-Fenster / Sample-Step / Forward-Fenster (Min)", "stalker.enabled": "Aktiv", "stalker.baseline_refresh_hours": "Baseline-Refresh (h)", "baseline_refresh_hours": "Baseline-Refresh (h)", "stalker.baseline_lookback_days": "Baseline-Lookback (Tage)", "baseline_lookback_days": "Baseline-Lookback (Tage)", "stalker.baseline_min_samples_schedule": "Min-Samples Schedule (Format: Tage:Wert — Komma-Liste, z.B. 0:2, 7:3, 14:5, 30:10)", "baseline_min_samples_schedule": "Min-Samples Schedule (Format: Tage:Wert — Komma-Liste, z.B. 0:2, 7:3, 14:5, 30:10)", "stalker.btc_regime.source_window_hours": "BTC-Regime Fenster (h)", "source_window_hours": "BTC-Regime Fenster (h)", "stalker.btc_regime.bull_threshold_pct": "BTC-Bull Schwelle (% Change)", "bull_threshold_pct": "BTC-Bull Schwelle (% Change)", "stalker.btc_regime.bear_threshold_pct": "BTC-Bear Schwelle (% Change)", "bear_threshold_pct": "BTC-Bear Schwelle (% Change)", "stalker.cross_coin.reference_coins": "Cross-Coin Reference (Komma-Liste)", "reference_coins": "Cross-Coin Reference (Komma-Liste)", "stalker.cross_coin.corr_windows_minutes": "Corr-Fenster Minuten (Komma-Liste)", "corr_windows_minutes": "Corr-Fenster Minuten (Komma-Liste)", "stalker.cross_coin.lead_lag_window_minutes": "Lead/Lag Fenster (min)", "lead_lag_window_minutes": "Lead/Lag Fenster (min)", "stalker.cross_coin.lead_lag_threshold_pct": "Lead/Lag Schwelle (% Reference-Move)", "lead_lag_threshold_pct": "Lead/Lag Schwelle (% Reference-Move)", "stalker.coin_identity.hash_slots": "Coin-Identity Hash-Slots", "hash_slots": "Coin-Identity Hash-Slots", "stalker.coin_identity.network_hash_slots": "Network Hash-Slots", "network_hash_slots": "Network Hash-Slots", "whale_tracker.enabled": "Aktiv", "whale_tracker.leaderboard_refresh_hours": "Leaderboard-Refresh (h)", "leaderboard_refresh_hours": "Leaderboard-Refresh (h)", "whale_tracker.fills_poll_seconds": "Fills-Poll (s)", "fills_poll_seconds": "Fills-Poll (s)", "whale_tracker.top_n_wallets": "Top-N Wallets", "top_n_wallets": "Top-N Wallets", "hide_after_hours": "Aus Liste verstecken nach (h)", "trading.default_leverage": "Hebel", "default_leverage": "Hebel", "trading.default_size_usd": "Trade-Size ($)", "default_size_usd": "Trade-Size ($)", "online_learner.enabled": "Online-Lerner aktiv", "self_calibration.enabled": "Selbstkalibrierung aktiv", "self_calibration.target_winrate": "Ziel-WR", "target_winrate": "Ziel-WR", "self_calibration.rolling_window": "Rolling-Window", "rolling_window": "Rolling-Window", "hl_cache_ttl_seconds": "HL-State-Cache TTL (s) — Balance/Positions/Orders", "hl_fills_ttl_seconds": "HL-Fills-Cache TTL (s) — Trade-History", "auto_trade": "Auto-Trade (Echtgeld HL)", "auto_long_enabled": "Long handeln", "auto_short_enabled": "Short handeln", "use_predictor_targets": "Nach Predictor-Vorgaben", "long_short_split": "Long/Short getrennt", "global_tp_pct": "TP % (vor Hebel)", "global_sl_pct": "SL % (vor Hebel)", "global_tp_pct_long": "TP % Long", "global_sl_pct_long": "SL % Long", "global_tp_pct_short": "TP % Short", "global_sl_pct_short": "SL % Short", "storm_warner.enabled": "Sturm-Warner an/aus (BTC-Turbulenz-Erkennung)", "storm_warner.vola_window_min": "Fenster (Min) für die BTC-Volatilitäts-Messung", "storm_warner.vola_threshold": "Vola-Schwelle: ab hier gilt 'Sturm' (höher = nur starke Stürme)", "storm_warner.volr_threshold": "Volumen-Ratio-Schwelle (Sturm-Bestätigung)", "storm_warner.oi_threshold_pct": "Open-Interest-Anstieg % (alternative Sturm-Bestätigung)", "storm_warner.wait_minutes": "Wartezeit (Min) nach Sturmstart, bis Richtung geklärt gilt (~88%)", "storm_warner.lookback_min": "Rückblick-Fenster (Min) für die Sturm-Auswertung", "storm_warner.protect_open_positions": "Bei geklärtem Sturm: Gegen-Positionen schließen", "storm_warner.gate_new_entries": "Bei Sturm: keine neuen Trades (Pause / Richtungs-Filter)", "rate_limit.enabled": "Rate-Sperre an/aus", "rate_limit.max_predictions": "Max. Predictions pro Zeitfenster", "rate_limit.window_minutes": "Zeitfenster (Min) für die Rate-Sperre", "vola_window_min": "Fenster (Min) für die BTC-Volatilitäts-Messung", "vola_threshold": "Vola-Schwelle: ab hier gilt 'Sturm' (höher = nur starke Stürme)", "volr_threshold": "Volumen-Ratio-Schwelle (Sturm-Bestätigung)", "oi_threshold_pct": "Open-Interest-Anstieg % (alternative Sturm-Bestätigung)", "wait_minutes": "Wartezeit (Min) nach Sturmstart, bis Richtung geklärt gilt (~88%)", "lookback_min": "Rückblick-Fenster (Min) für die Sturm-Auswertung", "protect_open_positions": "Bei geklärtem Sturm: Gegen-Positionen schließen", "gate_new_entries": "Bei Sturm: keine neuen Trades (Pause / Richtungs-Filter)", "max_predictions": "Max. Predictions pro Zeitfenster", "window_minutes": "Zeitfenster (Min) für die Rate-Sperre"}

function GenericField({ label, path, value, onChange }) {
  const d = SETTING_DESC[path] || SETTING_DESC[label] || ''
  const t = typeof value
  let input
  if (t === 'boolean') input = <input type="checkbox" checked={value} onChange={e => onChange(e.target.checked)} />
  else if (Array.isArray(value)) input = <input className="bg-gray-800 border border-gray-700 rounded px-2 py-0.5 text-xs text-gray-200 w-72" defaultValue={JSON.stringify(value)} onBlur={e => { try { onChange(JSON.parse(e.target.value)) } catch (x) {} }} title="JSON-Liste" />
  else if (t === 'number') input = <input type="number" step="any" className="bg-gray-800 border border-gray-700 rounded px-2 py-0.5 text-xs text-gray-200 w-36" value={value} onChange={e => onChange(e.target.value === '' ? null : parseFloat(e.target.value))} />
  else input = <input type="text" className="bg-gray-800 border border-gray-700 rounded px-2 py-0.5 text-xs text-gray-200 w-72" value={value ?? ''} onChange={e => onChange(e.target.value)} />
  return (
    <div className="my-1">
      <div className="flex items-center gap-2">
        <label className="text-gray-200 text-xs flex-1 truncate" title={path}>{label}</label>
        {input}
      </div>
      {d && <div className="text-gray-500 text-[10px] italic ml-1 mb-1">{d}</div>}
    </div>
  )
}
  ...
  return (
    <div style={{ marginLeft: path ? 10 : 0 }}>
      {Object.keys(data).map((k) => {
        ...
        return <GenericField key={p} label={k} path={p} value={v} onChange={(nv) => onSet(p, nv)} />
      })}
    </div>
  )
}
